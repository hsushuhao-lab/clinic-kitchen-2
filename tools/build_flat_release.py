"""Strict runtime-only build for the fixed 2D clinic. Original boards stay in Git, not Pages."""
...
def main():
 ...
 print('Flat runtime allowlist PASS:',len(files),'files; no private photos, art boards, tests or legacy GLB/Three.js included')
