...
def main():
    build_characters();verify_characters();build_workspace();verify_workspace()
    build_chibi();verify_chibi();build_clinic();build_service();verify_service();build_r6()
    ...
    files=list(CORE)
    for directory in ('assets/cooking','assets/ingredients/mapo_tofu','assets/ui','assets/r11/doctors','assets/r11/events'):
